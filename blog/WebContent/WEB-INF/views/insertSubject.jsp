		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				<div class="card-heading">
					<h2 class="title">>InsertSubject</h2>
				</div>
				<div class="card-body">
					<form method = "post" action="${pageContext.request.contextPath}/InsertSubjectListServlet">						
						<div class="form-row">
							<div class="name">
							SubjectName:
							</div>
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="subjectName">
								</div>
							</div>
						</div>						
						<div>
