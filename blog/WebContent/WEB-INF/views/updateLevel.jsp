				...
				<div class="card-body">
					<form method = "post" action="${pageContext.request.contextPath}/UpdateMemberLevel">				
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text"name="memberId" value="${member.memberId}" readonly>
								</div>
							</div>
						</div>	
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="password" name="memberPw" value="${member.memberPw}" readonly>
								</div>
							</div>
						</div>	
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="text" name="memberLevel" value="${member.memberLevel}">
								</div>
							</div>
						</div>						
						<div>
